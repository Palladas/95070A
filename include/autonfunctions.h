...
void driveintake(double distance){
  ...
  LeftDrive.move_relative(encoderticks, 127);
  RightDrive.move_relative(encoderticks, 127);
  LeftBack.move_relative(encoderticks, 127);
  RightBack.move_relative(encoderticks, 127);
  LeftIntake.move(127);
